...
<div class="h-screen flex flex-col space-y-10 justify-center items-center">
  <div class="bg-white w-96 shadow-xl rounded p-5">
    ...
    <form class="space-y-5 mt-5">
      <input type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Name" required/>
      <input type="email" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Email" required/>
      ...
      <button class="text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium">Register</button>
    </form>
  </div>
</div>
</template>
